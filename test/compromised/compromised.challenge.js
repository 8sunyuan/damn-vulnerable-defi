...
describe('Compromised challenge', function () {
    ...
    it('Execution', async function () {
        ...
        First convert hex to text, then decode from base64 to get the two results
        ...
        const wallet1 = new ethers.Wallet(privKey1, ethers.provider);
        const wallet2 = new ethers.Wallet(privKey2, ethers.provider);
        // console.log(wallet1.address);
        // console.log(wallet2.address);
        // We can see these 2 wallet addresses are sources for the oracle, we can manipulate the price now on the oracle
